  ...
  return (
    <NativeTabs
      ...
      <NativeTabs.Trigger name="forecast">
        <NativeTabs.Trigger.Label>{strings.tabs.forecast}</NativeTabs.Trigger.Label>
        <NativeTabs.Trigger.Icon sf="calendar" />
      </NativeTabs.Trigger>

      <NativeTabs.Trigger name="places">
        <NativeTabs.Trigger.Label>{strings.tabs.places}</NativeTabs.Trigger.Label>
        <NativeTabs.Trigger.Icon sf={{ default: 'mappin.and.ellipse', selected: 'mappin.and.ellipse' }} />
      </NativeTabs.Trigger>

      <NativeTabs.Trigger name="you">
        <NativeTabs.Trigger.Label>{strings.tabs.you}</NativeTabs.Trigger.Label>
