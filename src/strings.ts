...
export const strings = {
  ...
  you: {
    ...
    maxDistance: 'How far you will travel for the activity',
  ...
  help: {
    ...
    data: "Scores come from available mountain forecasts. Each place shows how old its conditions report is. Remember to check the operator's snow report before a long drive.",
  ...
  credits: {
    ...
    sources: [
      ...
      },
      {
        ...
        what: 'Most of the OpenSkiData listings are built by a dedicated group of contributors.',
  ...
  weakest: {
    ...
    nothingFalling: 'no new snow is falling',
